...
public enum ErrorMessage: Comparable {
...
public func ==(leftMsg: ErrorMessage, rightMsg: ErrorMessage) -> Bool {
...
/// The `ParseErrorType` defines the different types of parse errors that can occur.
/// Each case in the enum can have associated values that provide more context about the error.
...
public struct ParseError: Error, CustomStringConvertible {
    ...
    public var messages: [ErrorMessage] {
    ...
    private var _messages = [ErrorMessage]()
    ...
    init(position: SourcePosition, messages: [ErrorMessage]) {
    ...
    mutating func insertMessage(_ message: ErrorMessage) {
